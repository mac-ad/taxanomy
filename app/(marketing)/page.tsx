...
const features: Feature[] = [
  {
    ...
    title: "Next.js 13",
    description: "App router, Layouts, LoadingUI, API routes",
  },
  {
    icon: (
  ...
  },
  {
    ...
    title: "Supabase",
    description: "ORM using Prisma and deployed on Supabase.",
  },
  {
    icon: (
    ...
    title: "Tailwind CSS",
    description:
      "UI components built using Radix UI,ShadCN and styled with Tailwind CSS.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  return (
    <>
      <section className="container space-y-6 py-10 text-center">
        <Link
          href="#"
          className="text-sm font-medium  px-4 py-1.5 rounded-full bg-muted"
        >
          Connect with me on Twitter
        </Link>
        <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl  max-w-[25ch] mx-auto">
          A Blogging Platform for Developers
        </h1>
        <p className="text-muted-foreground max-w-[60ch] mx-auto md:text-lg ">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut nam
          labore cumque sint, culpa corporis omnis eaque accusamus quam ad!
        </p>
      ...
      <section
        id="features"
        className="bg-muted dark:bg-transparent py-10 text-center"
      >
        <div className="container space-y-6">
          <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl  max-w-[25ch] mx-auto">
            Features
          </h1>
          <p className="text-muted-foreground max-w-[60ch] mx-auto md:text-lg max-w-[60ch]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut nam
            labore cumque sint, culpa corporis omnis eaque accusamus quam ad!
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-[64rem] mx-auto">
            {features?.map((f, idx) => (
              <div
                key={idx}
                className="h-[180px] border p-6 justify-center rounded-md bg-background flex flex-col items-start text-left"
              >
                <div className="h-12 w-12 mb-5 saturate-0">{f?.icon}</div>
      ...
      <section className="container space-y-6 py-10 text-center">
        <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl  max-w-[25ch] mx-auto">
          Proudly Open Source
        </h1>
        <div>
          <p className="text-muted-foreground max-w-[48ch] mx-auto md:text-lg ">
            Taxanomy is an open source software and is powered by collection of
